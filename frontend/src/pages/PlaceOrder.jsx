  ...
  return (
    <div className="flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t border-gray-300">
      ...
      <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">  
        ...
        <div className="flex gap-3">
          <input type="text" placeholder='Your city' className="border border-gray-300 rounded py-1.5 px-3.5 w-full" />
          <input type="text" placeholder='State info' className="border border-gray-300 rounded py-1.5 px-3.5 w-full" />
        </div>
        <div className="flex gap-3">
        ...
        <input type="number" placeholder='Your Phone no-' className="border border-gray-300 rounded py-1.5 px-3.5 w-full" />
      </div>
        ...
        <div className="mt-12">
          ...
          <div className="flex gap-3 flex-col lg:flex-row">
            <div  onClick={()=>setMethod('stripe')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer border-gray-300">
             <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-400 ${method === 'stripe'? 'bg-green-400' : ''}`}></p> 
            ...
            <div onClick={()=>setMethod('razorpay')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer border-gray-300">
             <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-400 ${method === 'razorpay'? 'bg-green-400' : ''}`}></p> 
            ...
            <div onClick={()=>setMethod('cod')} className="flex items-center gap-3 border p-2 px-3 cursor-pointer border-gray-300">
             <p className={`min-w-3.5 h-3.5 border rounded-full border-gray-400 ${method === 'cod'? 'bg-green-400' : ''}`}></p> 
